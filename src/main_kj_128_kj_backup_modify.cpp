...
public:
    ...
    void groundRemoval()
    {
        ...
        //         targetInd = j + (i * Horizon_SCAN); // 1 ~ 1024   ,, 1025~ 2048

        //         if (fullCloud->points[targetInd].intensity == -1)
        //         {   
        //             groundMat.at<int8_t>(i, j) = -1;
        //             continue;
        //         }
        //         if (mingroundz > fullCloud->points[targetInd].z){
        //             mingroundz = fullCloud->points[targetInd].z;
        //         }
        //     }

        //     for (size_t j = 0; j < Horizon_SCAN; ++j){
        //         targetInd = j + (i * Horizon_SCAN); // 1 ~ 1024   ,, 1025~ 2048
        //         if (fullCloud->points[targetInd].intensity != -1 && abs(mingroundz - fullCloud->points[targetInd].z) < 1)
        //         {   
        //         groundMat.at<int8_t>(i, j) = 1;
        //         }
        //     }
        ...
        for (size_t j = 0; j < Horizon_SCAN; ++j)
        {
            for (size_t i = 0; i < N_SCAN; ++i)
            {
                ...
                else if (groundMat.at<int8_t>(i, j) == 0)
                {
